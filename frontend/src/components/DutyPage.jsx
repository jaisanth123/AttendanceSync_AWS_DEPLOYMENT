    ...
    <div className="flex flex-col items-center flex-1 p-6 md:p-8 lg:p-12">
      <div className="w-full max-w-4xl p-6 bg-gray-800 rounded-lg shadow-lg">
        ...
        <button
          ...
          className="w-full px-6 py-3 mt-6 text-lg text-white bg-gray-800 rounded-lg lg:w-1/4 md:w-1/5 sm:w-1/2 hover:bg-gray-600"
          disabled={isLoading}
        >
          {isLoading ? "Fetching..." : "Fetch Students"}
        </button>
        ...
        {rollNumbers.length > 0 && (
          <button
            ...
            className="w-full px-6 py-3 mt-6 text-lg text-white bg-blue-600 rounded-lg lg:w-1/4 md:w-1/5 sm:w-1/2 hover:bg-blue-500"
          >
            Update Attendance
          </button>
        )}
