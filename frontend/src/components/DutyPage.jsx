...
function DutyPage() {
  ...
  const fetchRollNumbers = async (yearOfStudy, branch, section, selectedDate) => {
    ...
    const url = `${import.meta.env.VITE_BACKEND_URL}/api/students/remaining?yearOfStudy=${yearOfStudy}&branch=${branch}&section=${section}&date=${selectedDate}`;
  ...
  const handleConfirm = async () => {
    ...
    try {
      const response = await axios.post("${import.meta.env.VITE_BACKEND_URL}/api/attendance/onDuty", payload);
